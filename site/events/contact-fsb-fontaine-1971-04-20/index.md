...
units:
  ...
  supporting:
    - name: 2/8 CAV Battalion (C&C)
      role: Command and control, aerial — LTC Bacon
    - name: Direct Support and General Support Artillery (incl. 8-inch, Xuan Loc)
      role: Fire support during engagement and overnight bombardment
    - name: Aerial Rocket Artillery (ARA) and Air Cav gunships
      role: Fire support during engagement
    - name: USAF F-100s (6 aircraft)
...
tagged:
  ...
  - slug: brothers-harvey
    name: Doc Harvey Brothers
    note: Medic, Range Platoon; treated Dillon at the stream
  - slug: kahnke-steve
    name: SGT Steve Kahnke
    note: Acting FO; directed artillery with Neal through the night of 4/20–21
  - slug: guidara-frank
    name: Frank Guidara
    note: Logistics officer; organized ammo resupply choppered in during the fight
  - slug: martin-michael
