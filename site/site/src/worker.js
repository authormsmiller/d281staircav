...
async function handleMedia(request, env, path) {
  ...
  // /media/photos/soldiers/weaver-ken/profile/weaver-ken.jpg
  //   → PHOTOS bucket, key: soldiers/weaver-ken/profile/weaver-ken.jpg
  // /media/documents/newsletters/issue-001.pdf
  //   → DOCUMENTS bucket, key: newsletters/issue-001.pdf
